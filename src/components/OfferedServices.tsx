...
const OfferedServices = () => {
  return (
    <div className='bg-blue-50 pb-12 text-justify md:pb-40 md:text-left'>
      <div className='mx-auto max-w-[1100px] px-8 py-20 xl:px-0'>
        <h3 className='mb-32 text-center font-dm text-5xl font-bold text-dark-blue md:text-7xl'>
          Services
        </h3>
        <section className='grid items-center gap-12 md:grid-cols-[0.7fr_1fr]'>
          <div className='order-2 md:order-1'>
            <h2 className='text-center font-dm text-5xl font-extrabold tracking-tight text-neutral-800 md:text-left'>
              UGC at scale
            </h2>
            ...
            <Button
              size='lg'
              className='mt-12 w-full rounded-full bg-blue-600 py-10 text-xl font-bold text-primary-foreground text-white md:w-auto'
            >
              Explore Product
            </Button>
          </div>
        ...
        <section className='mt-28 grid items-center gap-12 md:mt-48 md:grid-cols-[1fr_0.7fr]'>
          <div className='order-2 md:order-2'>
            <h2 className='text-center font-dm text-5xl font-extrabold leading-[4rem] tracking-tight text-neutral-800 md:text-left'>
              Manage the output
            </h2>
            <p className='mt-8 text-xl text-neutral-700'>
              Collect and publish photo, text, and video reviews from verified

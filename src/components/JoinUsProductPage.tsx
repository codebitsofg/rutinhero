...
const JoinUsProductPage = () => {
  return (
    <section className='container mx-auto px-4 pt-12 md:py-24'>
      <div className='relative mb-3 mt-4 flex w-full max-w-7xl flex-col items-center justify-center rounded-[3rem] bg-black px-6 py-12 text-center lg:mx-auto lg:mt-8 lg:flex-row lg:space-x-16'>
        <div className='space-y-6'>
          ...
          <h1 className='font-dm text-4xl font-bold tracking-tight text-white md:text-5xl'>

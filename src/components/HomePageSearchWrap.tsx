...
const HomePageSearchWrap = () => {
  ...
  return (
    <div className='relative flex justify-center px-4 pt-28 font-["Inter"] md:min-h-screen md:px-0 md:pt-60'>
      <div className='relative z-10 flex w-full flex-col items-center gap-4'>
        <h1 className='text-center font-dm text-[2.5rem] font-extrabold leading-[3rem] text-blue-900 md:max-w-[60%] md:text-[4.5rem] md:leading-[6rem]'>
